...
_TABLE: dict[GPUClass, dict] = {
    GPUClass.CPU: dict(
        ...
        use_fp8_fwd=False, chunk_size_default=512,
    ),
    GPUClass.LAPTOP_ADA: dict(
        ...
        triton_stages_flash=2, triton_stages_ema=3,
        triton_warps_base=4,
        ...
        use_fp8_fwd=False, chunk_size_default=2048,
    ),
    GPUClass.DESKTOP_ADA: dict(
        ...
        use_fp8_fwd=False, chunk_size_default=4096,
    ),
    ...
    GPUClass.AMPERE_HPC: dict(
        ...
        use_fp8_fwd=False, chunk_size_default=8192,
    ),
    GPUClass.HOPPER: dict(
        ...
        compile_fullgraph=True,
        cuda_graph_safe=True, ring_size=32, graph_warmup_iters=5,
        use_fp8_fwd=True, chunk_size_default=16384,
    ),
    GPUClass.BLACKWELL: dict(
        ...
        use_fp8_fwd=True, chunk_size_default=32768,
    ),
}
